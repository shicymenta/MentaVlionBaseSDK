 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `MVYYModel` protocol for custom methods.
 ...
 Sample Code:
     ...
     ********************** json convertor *********************
 @code
     @interface MVYYAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation MVYYAuthor
     @end
 
     @interface MVYYBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) MVYYAuthor *author;
     @end
     @implementation MVYYBook
     @end
    
     int main() {
         // create model from json
         MVYYBook *book = [MVYYBook mvyy_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book mvyy_modelToJSONString];
 ...
 @code
     @interface MVYYShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation MVYYShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self mvyy_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self mvyy_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self mvyy_modelCopy]; }
     - (NSUInteger)hash { return [self mvyy_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self mvyy_modelIsEqual:object]; }
     @end
 @endcode
 
 */
@interface NSObject (MVYYModel)
 ...
 */
+ (nullable instancetype)mvyy_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> NSDate, parsed with format "mvyymvyy-MM-dd'T'HH:mm:ssZ", "mvyymvyy-MM-dd HH:mm:ss" or "mvyymvyy-MM-dd".
     `NSString` -> NSURL.
     `NSValue` -> struct or union, such as CGRect, CGSize, ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)mvyy_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)mvyy_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)mvyy_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)mvyy_modelToJSONObject;
 ...
 */
- (nullable NSData *)mvyy_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)mvyy_modelToJSONString;
 ...
 */
- (void)mvyy_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)mvyy_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
- (BOOL)mvyy_modelIsEqual:(id)model;
 ...
 */
- (NSString *)mvyy_modelDescription;
 ...
 */
+ (nullable NSArray *)mvyy_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (MVYYModel)
 ...
 */
+ (nullable NSDictionary *)mvyy_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<MVYYModel>' to your class header.
 */
@protocol MVYYModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class MVYYShadow, MVYYBorder, MVYYAttachment;
 
        @interface MVYYAttributes
        @property NSString *name;
        ...
        @implementation MVYYAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [MVYYShadow class],
                     @"borders" : MVYYBorder.class,
                     @"attachments" : @"MVYYAttachment" };
        }
        @end
  @endcode
...
/**
 ...
 Example:
 @code
        @class MVYYCircle, MVYYRectangle, MVYYLine;
 
        @implementation MVYYShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [MVYYCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [MVYYRectangle class];
            } else if (dictionary[@"y2"] != nil) {
                return [MVYYLine class];
            } else {
                return [self class];
            }
        }
