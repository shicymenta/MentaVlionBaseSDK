...
/** Category of additions for `<MENTADatabase>` class.
...
@interface MENTADatabase (MENTADatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `MENTAResultSet` of schema; `nil` on error.
 
 @see [SQLite File Format](http://www.sqlite.org/fileformat.html)
 */

- (MENTAResultSet * _Nullable)getSchema;
...
- (MENTAResultSet * _Nullable)getTableSchema:(NSString*)tableName;
